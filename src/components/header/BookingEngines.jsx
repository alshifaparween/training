...
import styles from './BookingEngines.module.css';
...
function BookingEngines() {
  return (
    <>
      ...
      <div className={`d-flex ${styles.midsec_23}`}>
        <div className="col-lg-6">
          <h2>CRM and Softwares</h2>
          <p>
            A booking engine is a piece of software that helps companies handle
            and streamline their online reservation process. It is the
            foundation for flawless booking experiences and is mostly utilized
        ...
        <div className="col-lg-6 text-center">
          <img src={image4} alt="" height="460px" />
        </div>
      </div>

      <div className={`d-flex ${styles.midsec_2}`}>
        <div className="col-lg-6">
          <img src={image4} alt="" height="500px" />
        </div>
        <div className="col-lg-6">
          <h2>API Intergrations</h2>
          <p>
            A booking engine is a piece of software that helps companies handle
            and streamline their online reservation process. It is the
            foundation for flawless booking experiences and is mostly utilized
